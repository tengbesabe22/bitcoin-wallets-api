...
describe('MULTISIGNATURE WALLETS', function () {
    it('should generate correct 2-out-of-3 multisig P2SH address', function () {
    ...
    it('should generate correct 3-out-of-3 multisig P2SH address', function () {
        var wallet = wallets_1.generateP2SHWallet(3, 3, [
            "03af4bb0fac753a87702a6da9aee0dd07338447162940ca7131414ebe869421caf",
            "023fc8a9b508d06b47f92376df12d8a356472676e34037409bd3cc36da235c1709",
            "03b6c2789cfc591f8c16d2cd6f2bc3551c6825febebcc20d5519e57415bb636cd6"
        ]);
    ...
    it('should throw error on public keys length is less than m', function () {
        expect(function () {
            wallets_1.generateP2SHWallet(2, 4, [
                "03af4bb0fac753a87702a6da9aee0dd07338447162940ca7131414ebe869421caf",
                "023fc8a9b508d06b47f92376df12d8a356472676e34037409bd3cc36da235c1709",
                "03b6c2789cfc591f8c16d2cd6f2bc3551c6825febebcc20d5519e57415bb636cd6"
            ]);
    ...
    it('should throw error on public keys length is more than m', function () {
        expect(function () {
            wallets_1.generateP2SHWallet(2, 3, [
                "03af4bb0fac753a87702a6da9aee0dd07338447162940ca7131414ebe869421caf",
                "023fc8a9b508d06b47f92376df12d8a356472676e34037409bd3cc36da235c1709",
                "03b6c2789cfc591f8c16d2cd6f2bc3551c6825febebcc20d5519e57415bb636cd6",
    ...
    it('should throw error on n is greater than m', function () {
        expect(function () {
            wallets_1.generateP2SHWallet(4, 3, [
                "03af4bb0fac753a87702a6da9aee0dd07338447162940ca7131414ebe869421caf",
                "023fc8a9b508d06b47f92376df12d8a356472676e34037409bd3cc36da235c1709",
                "03b6c2789cfc591f8c16d2cd6f2bc3551c6825febebcc20d5519e57415bb636cd6"
            ]);
    ...
    it('should throw error on invalid public key', function () {
        expect(function () {
            wallets_1.generateP2SHWallet(2, 3, [
